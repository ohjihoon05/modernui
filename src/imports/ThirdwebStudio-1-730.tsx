import svgPaths from "./svg-vfifz9x54k";
  ...
  return (
    <div className="h-[217px] relative shrink-0 w-[594px]" data-name="text-infinite.svg">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 594 217">
        <g clipPath="url(#clip0_1_734)" id="text-infinite.svg">
          <path d={svgPaths.p110b8300} id="Vector" stroke="url(#paint0_linear_1_734)" strokeLinecap="square" strokeMiterlimit="10" />
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_734" x1="77" x2="543" y1="115" y2="109">
...
function AboutShape03Svg() {
  return (
    <div className="absolute left-0 size-[414px] top-0" data-name="about-shape03.svg">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 414 414">
        <g clipPath="url(#clip0_1_803)" id="about-shape03.svg">
          <path d={svgPaths.p18c65500} id="Vector" stroke="var(--stroke-0, #353535)" />
        </g>
        <defs>
...
function Div29() {
  return (
    <div className="absolute bottom-[-280px] left-[-368px] size-[414px]" data-name="div">
      <AboutShape03Svg />
    </div>
  );
}
